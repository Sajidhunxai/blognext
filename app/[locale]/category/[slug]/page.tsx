    ...
    <>
      ...
      <FrontendLayout>
        <div className="bg-theme-background">
          {/* Hero Section */}
          <section className="relative py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-primary">
                ...
                <>
                      ...
                      >
                        ...
                        <p className="text-xs text-gray-600 mb-2">
                          ...
                          {(post as any).appVersion ||
                            ((post as any).downloadLink ? "V1.0" : "N/A")}
                        </p>
                  ...
                  {totalPages > 1 && (
                    <PaginationWrapper
                      ...
                      baseUrl={addLocalePrefix(`/category/${category.slug}`, locale)}
                    />
                  )}
                </>
              )}
