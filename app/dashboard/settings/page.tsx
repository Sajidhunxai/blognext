...
export default async function SettingsPage() {
  ...
  const initialSettings = {
    ...
    darkModeLogo: (settingsData as any).darkModeLogo || "",
    ...
    enableWatermark: (settingsData as any).enableWatermark === true,
    watermarkImage: (settingsData as any).watermarkImage || "",
    watermarkPosition: (settingsData as any).watermarkPosition || "bottom_right",
    watermarkOpacity: typeof (settingsData as any).watermarkOpacity === 'number' ? (settingsData as any).watermarkOpacity : 70,
    watermarkScale: typeof (settingsData as any).watermarkScale === 'number' ? (settingsData as any).watermarkScale : 15,
